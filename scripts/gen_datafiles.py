...
def pendulum_40(t, T):
    return np.array([T[1], (-32.97025023) * np.sin(T[0]) - 0.13525474905859805 * T[1]])

def pendulum_15(t, T):
    return np.array([T[1], (-32.97025023) * np.sin(T[0]) - 0.18352419291242508 * T[1]])
...
teorica_data_15 = pendulum_15_teorica(time_15, 0.2606531288, 0.18352419291242508 / 2, 5.81434611, 0)
